...
**Rola:** ${role.name}
  ...
  client.on("guildMemberNicknameUpdate", (member, oldNickname, newNickname) => {
    const embed = new EmbedBuilder()
      ...
      .setDescription(`
**Czytelnik:** ${member.user.tag}
**Stary pseudonim:** ${oldNickname} 
**Nowy pseudonim:** ${newNickname}
            `);
...
**Nowy poziom:** ${newLevel}`);
  ...
  client.on("guildBoostLevelDown", (guild, oldLevel, newLevel) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Pink")
      .setDescription(
        `${guild.name} spadł z ${oldLevel} poziomu na ${newLevel} poziom`
      );
  ...
  client.on("guildAfkChannelAdd", (guild, afkChannel) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `${guild.name} posiada teraz nowy kanał AFK: ${afkChannel}`
      );
  ...
  client.on("guildVanityURLAdd", (guild, vanityURL) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `${guild.name} posiada teraz specjalne zaproszenie: ${vanityURL}`
      );
  ...
  client.on("guildVanityURLRemove", (guild, vanityURL) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Red")
      .setDescription(
        `${guild.name} nie posiada teraz specjalnego zaproszenia: ${vanityURL}`
      );
  ...
  client.on("guildVanityURLUpdate", (guild, oldVanityURL, newVanityURL) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `Serwer ${guild.name} zmienił swoje specjalne zaproszenie z ${oldVanityURL} na ${newVanityURL}!`
      );
  ...
  client.on("messagePinned", (message) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Grey")
      .setDescription(
        `Wiadomość ${message} została przypięta przez ${message.author}`
      );
  ...
  client.on("messageContentEdited", (message, oldContent, newContent) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Grey")
      .setDescription(
        `Zawartość wiadomości została zmieniona z \`${oldContent}\` na \`${newContent}\` przez ${message.author}`
      );
  ...
  client.on("userAvatarUpdate", (user, oldAvatarURL, newAvatarURL) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `Czytelnik ${user.tag} zmienił swoje profilowe z [Starego](${oldAvatarURL}) na [Nowe(${newAvatarURL})]`
      );
  ...
  client.on("userUsernameUpdate", (user, oldUsername, newUsername) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `Czytelnik ${user.tag} zmienił swoją nazwę użytkownika z ${oldUsername} na ${newUsername}`
      );
  ...
  client.on(
    ...
    (user, oldDiscriminator, newDiscriminator) => {
      const embed = new EmbedBuilder()
        ...
        .setColor("Green")
        .setDescription(
          `Czytelnik ${user.tag} zmienił swój tag z ${oldDiscriminator} na ${oldDiscriminator}`
        );
  ...
  client.on("userFlagsUpdate", (user, oldFlags, newFlags) => {
    const embed = new EmbedBuilder()
      ...
      .setColor("Green")
      .setDescription(
        `Czytelnik ${user.tag} zaktualizował swoje flagi z ${oldFlags} na ${newFlags}`
      );
